...
import com.marse.time.ontime.Settings.SettingsActivity;
import com.marse.time.ontime.TimeTable.FragmentPager;
import com.marse.time.ontime.TimeTable.RecyclerAdapter;
import com.marse.time.ontime.TimeTable.TimeTableFragment;
...
public class MainActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreference() {
        ...
        if (NetworkActivity.isNetworkAvailable(this)) {
            SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);
